...
public class CondenserSyncPKT implements IMessage
{
	...
	public CondenserSyncPKT(double displayEmc, int requiredEmc, int x, int y, int z) 
	{
	...
	public static class Handler implements IMessageHandler<CondenserSyncPKT, IMessage>
	{
		...
		{
			TileEntity tile = Minecraft.getMinecraft().theWorld.getBlockTileEntity(pkt.x, pkt.y, pkt.z);
