...
public class ParticlePKT implements IMessage
{
	...
	public static class Handler implements IMessageHandler<ParticlePKT, IMessage>
	{
		...
		{
			Minecraft.getMinecraft().theWorld.spawnParticle(moze_intel.projecte.compat.PECompatHelper.getParticle(message.particleName), message.x, message.y, message.z, message.velX, message.velY, message.velZ);
			return null;
		}
	}
}
