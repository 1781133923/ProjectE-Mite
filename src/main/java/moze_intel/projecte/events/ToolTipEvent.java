...
public class ToolTipEvent 
{
	...
	public void tTipEvent(ItemTooltipEvent event)
	{
		...
		Block currentBlock = moze_intel.projecte.compat.PECompatHelper.getBlockFromItem(currentItem);
		...
		{
			event.toolTip.add("UN: " + moze_intel.projecte.compat.PECompatHelper.getItemName(current.getItem()));
		}
