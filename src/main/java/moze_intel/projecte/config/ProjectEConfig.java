...
public final class ProjectEConfig 
{
	...
	public static void init(File configFile)
	{
		...
		try
		{
			...
			interdictionMode = config.getBoolean("interdictionMode", "effects", false, "If true the Interdiction Torch only affects hostile mobs. If false it affects all non blacklisted living entities.");
