...
public class DMFurnaceContainer extends Container
{
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotIndex)
	{
		...
		else
		{
			...
			if (moze_intel.projecte.compat.PECompatHelper.isFuel(newStack) || newStack.getItem() instanceof IItemEmc)
			{
			...
			else if (FurnaceRecipes.smelting().getSmeltingResult(newStack, -1) != null)
			{
