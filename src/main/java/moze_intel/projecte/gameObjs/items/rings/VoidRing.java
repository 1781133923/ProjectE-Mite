...
public class VoidRing extends GemEternalDensity implements IPedestalItem, IExtraFunction
{
	...
	private Icon void_off;
	@SideOnly(Side.CLIENT)
	private Icon void_on;
	...
	public void addInformation(ItemStack stack, EntityPlayer player, java.util.List list, boolean par4, net.minecraft.Slot slot)
	{
		...
		list.add(net.minecraft.EnumChatFormatting.BLUE + net.minecraft.StatCollector.translateToLocal("pe.voidring.tooltip1"));
	}
