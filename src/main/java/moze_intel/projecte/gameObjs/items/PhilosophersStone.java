...
public class PhilosophersStone extends ItemMode implements IProjectileShooter, IExtraFunction
{
	...
	private void changeBlock(World world, MetaBlock pointed, MetaBlock result, int x, int y, int z, EntityPlayer player)
	{
		...
		{
			PlayerHelper.checkedReplaceBlock(((ServerPlayer) player), x, y, z, result.getBlock(), result.getMeta());
	...
	public void doExtraFunction(ItemStack stack, EntityPlayer player) 
	{
		...
		{
			moze_intel.projecte.compat.PEGuiHelper.openGui(player, Constants.PHILOS_STONE_GUI, player.worldObj, (int) player.posX, (int) player.posY, (int) player.posZ);
		}
	}
