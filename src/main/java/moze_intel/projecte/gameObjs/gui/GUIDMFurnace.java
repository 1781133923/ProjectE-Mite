...
public class GUIDMFurnace extends GuiContainer
{
	...
	{
		this.fontRenderer.drawString(StatCollector.translateToLocal("pe.dmfurnace.shortname"), 57, 5, 4210752);
		this.fontRenderer.drawString(StatCollector.translateToLocal("container.inventory"), 57, ySize - 96 + 2, 4210752);
	}
}
