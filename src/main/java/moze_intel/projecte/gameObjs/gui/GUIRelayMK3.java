...
public class GUIRelayMK3 extends GuiContainer
{
	...
	{
		this.fontRenderer.drawString(StatCollector.translateToLocal("pe.relay.mk3"), 38, 6, 4210752);
		this.fontRenderer.drawString(Integer.toString(tile.displayEmc), 125, 39, 4210752);
	}
