...
public class GUIRelayMK1 extends GuiContainer
{
	...
	{
		this.fontRenderer.drawString(StatCollector.translateToLocal("pe.relay.mk1"), 10, 6, 4210752);
		this.fontRenderer.drawString(Integer.toString(tile.displayEmc), 88, 24, 4210752);
	}
