...
public class GUIRMFurnace extends GuiContainer 
{
	...
	{
		this.fontRenderer.drawString(StatCollector.translateToLocal("pe.rmfurnace.shortname"), 76, 5, 4210752);
		this.fontRenderer.drawString(StatCollector.translateToLocal("container.inventory"), 76, ySize - 96 + 2, 4210752);
	}
}
