...
public class DMPedestalTile extends TileEmc implements IInventory
{
	...
	{
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.2, yCoord + 0.3, zCoord + 0.2, 0, 0, 0);
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.2, yCoord + 0.3, zCoord + 0.5, 0, 0, 0);
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.2, yCoord + 0.3, zCoord + 0.8, 0, 0, 0);
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.5, yCoord + 0.3, zCoord + 0.2, 0, 0, 0);
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.5, yCoord + 0.3, zCoord + 0.8, 0, 0, 0);
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.8, yCoord + 0.3, zCoord + 0.2, 0, 0, 0);
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.8, yCoord + 0.3, zCoord + 0.5, 0, 0, 0);
		worldObj.spawnParticle(EnumParticle.flame, xCoord + 0.8, yCoord + 0.3, zCoord + 0.8, 0, 0, 0);
		for (int l = 0; l < 3; ++l) // Ripped from vanilla enderchest
		{
			...
			worldObj.spawnParticle(EnumParticle.portal_nether, d0, d1, d2, d3, d4, d5);
		}
	}
	...
	public void setActive(boolean newState)
	{
		if (newState != this.getActive() && worldObj != null)
		{
			if (newState)
			{
				...
				{
					this.worldObj.spawnParticle(EnumParticle.witchMagic, centeredX + worldObj.rand.nextGaussian() * 0.12999999523162842D,
			...
			else
			{
				...
				for (int i = 0; i < worldObj.rand.nextInt(35) + 10; ++i)
				{
					this.worldObj.spawnParticle(EnumParticle.smoke, centeredX + worldObj.rand.nextGaussian() * 0.12999999523162842D,
							yCoord + 1 + worldObj.rand.nextGaussian() * 0.12999999523162842D,
							centeredZ + worldObj.rand.nextGaussian() * 0.12999999523162842D,
							0.0D, 0.0D, 0.0D);
				}
