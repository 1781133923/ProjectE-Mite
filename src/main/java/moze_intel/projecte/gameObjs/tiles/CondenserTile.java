...
public class CondenserTile extends TileEmcDirection implements IInventory, ISidedInventory, IEmcAcceptor
{
	...
	public void checkLockAndUpdate()
	{
		...
		{
			int lockEmc = EMCHelper.getBuyValue(lock);
	...
	protected void condense()
	{
		for (int i = 1; i < 92; i++)
		{
			...
			decrStackSize(i, 1);
			this.addEMC(EMCHelper.getSellValue(stack));
			break;
		}
	...
	public void updateChest()
	{
		...
		{
			worldObj.addBlockEvent(xCoord, yCoord, zCoord, ObjHandler.condenser.blockID, 1, numPlayersUsing);
		}
