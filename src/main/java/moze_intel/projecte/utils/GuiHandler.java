	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		switch (ID)
		{
			...
			case Constants.ALCH_BAG_GUI:
				return new AlchBagContainer(player.inventory, new AlchBagInventory(player, player.getHeldItemStack()));
			...
			case Constants.MERCURIAL_GUI:
				return new MercurialEyeContainer(player.inventory, new MercurialEyeInventory(player.getHeldItemStack()));
			...
			case Constants.ETERNAL_DENSITY_GUI:
				return new EternalDensityContainer(player.inventory, new EternalDensityInventory(player.getHeldItemStack(), player));
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) 
	{
		...
		switch (ID)
		{
			case Constants.ALCH_CHEST_GUI:
				...
				break;
			case Constants.ALCH_BAG_GUI:
				return new GUIAlchChest(player.inventory, new AlchBagInventory(player, player.getHeldItemStack()));
			case Constants.CONDENSER_GUI:
				if (tile != null && tile instanceof CondenserTile)
			...
			case Constants.RELAY3_GUI:
				...
				break;
			case Constants.MERCURIAL_GUI:
				return new GUIMercurialEye(player.inventory, new MercurialEyeInventory(player.getHeldItemStack()));
			case Constants.PHILOS_STONE_GUI:
			...
			case Constants.ETERNAL_DENSITY_GUI:
				...
				return new GUIEternalDensity(player.inventory, new EternalDensityInventory(player.getHeldItemStack(), player));
			case Constants.CONDENSER_MK2_GUI:
